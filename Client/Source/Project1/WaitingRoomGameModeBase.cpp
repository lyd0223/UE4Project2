...
#include "UI/WaitingRoomLevel/Store/StoreMainWidget.h"
...
AWaitingRoomGameModeBase::AWaitingRoomGameModeBase()
{
	...
	static ConstructorHelpers::FClassFinder<APawn> GunnerClass(
		TEXT("Blueprint'/Game/01Resources/Player/Gunner/BPGunner.BPGunner_C'"));
	if (GunnerClass.Succeeded())
		m_PlayerClassArray.Add(GunnerClass.Class);

	static ConstructorHelpers::FClassFinder<APawn> BelicaClass(
		TEXT("Blueprint'/Game/01Resources/Player/Belica/BPBelica.BPBelica_C'"));
	if (BelicaClass.Succeeded())
		m_PlayerClassArray.Add(BelicaClass.Class);

	static ConstructorHelpers::FClassFinder<APawn> RevenantClass(
		TEXT("Blueprint'/Game/01Resources/Player/Gunner/BPGunner.BPGunner_C'"));
	...
	static ConstructorHelpers::FClassFinder<UWaitingRoomMainWidget>
		WidgetClass(
			TEXT("WidgetBlueprint'/Game/01Resources/UI/WaitingRoomLevel/UI_WaitingRoomMain.UI_WaitingRoomMain_C'"));
